                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 0865096808</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> duynq218@uef.edu.vn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{('public/frontend/images/79shop.gif')}}" height="42px" width="160px" margin-right ="10px" alt="" /></a>
                        </div>
